...
_hsp.push(["addCookieDomain", ".appetize.io"]);
...
!(function (t) {
  ...
  n.p = "//static.hsappstatic.net/cookie-banner-js/static-1.1323/";
  n((n.s = 3));
})([
  function (t, e, n) {
    var o;
    function s() {
      ...
      for (t = 0; t < this.config.elements.length; t++)
        this.allowed_elements[this.config.elements[t]] = !0;
      this.config.remove_element_contents = {};
      this.config.remove_all_contents = !1;
      if (e.remove_contents)
        if (e.remove_contents instanceof Array)
          for (t = 0; t < e.remove_contents.length; t++)
            this.config.remove_element_contents[e.remove_contents[t]] = !0;
    ...
    s.prototype.clean_node = function (t) {
      ...
      function a(t) {
        ...
        switch (t.nodeType) {
          ...
          default:
            console &&
              console.log &&
              console.log("unknown node type", t.nodeType);
        }
      }
      function r(t) {
        var e,
          ...
          for (e = 0; e < l.length; e++) {
            ...
            if ((h = t.attributes[d])) {
              ...
              if (this.config.protocols[r] && this.config.protocols[r][d]) {
                ...
                f = (p = h.value.toLowerCase().match(s.REGEX_PROTOCOL))
                  ? -1 != n(p[1], m)
                  : -1 != n(s.RELATIVE, m);
              }
              if (f) {
          ...
          if (this.config.add_attributes[r])
            for (d in this.config.add_attributes[r]) {
              (u = document.createAttribute(d)).value =
                this.config.add_attributes[r][d];
              this.current_element.setAttributeNode(u);
            }
        ...
        if (
          ...
          !this.config.remove_element_contents[r]
        )
          for (e = 0; e < t.childNodes.length; e++)
            a.call(this, t.childNodes[e]);
      ...
      function c(t) {
        var e,
          i,
          s,
          a = { attr_whitelist: [], node: t, whitelist: !1 };
        for (e = 0; e < this.transformers.length; e++)
          if (
            null !=
            (s = this.transformers[e]({
            ...
            s.attr_whitelist &&
              (a.attr_whitelist = o(a.attr_whitelist, s.attr_whitelist));
  ...
  function (t, e, n) {
    ...
    class T {
      ...
      info(t) {
        this.isDebugEnabled() &&
          this.context.getWindow().console.log(`${this.logPrepend} ${t}`);
      }
      debug(t) {
        this.isDebugEnabled() &&
          this.context.getWindow().console.debug(`${this.logPrepend} ${t}`);
      }
      error(t) {
        this.isDebugEnabled() &&
          this.context.getWindow().console.error(`${this.logPrepend} ${t}`);
      }
      isDebugEnabled() {
    ...
    class O {
      constructor(t, e, n) {
        ...
        this.allUrlsAndLocations
          ? (this.configType = E.ALL_URLS)
          : (this.configType = o && i ? E.PATH_AND_GEO : i ? E.GEO : E.PATH);
      }
      getMatchLevel() {
      ...
      static fromJS(t) {
        const { allUrlsAndLocations: e, path: n, targetedCountries: o } = t;
        return new O(e, n, o);
      }
    }
    class A {
    ...
    class I {
      ...
      static fromJS(t) {
        const { position: e, accentColor: n, showCloseButton: o } = t;
    ...
    class H {
      ...
      static fromJS(t) {
        return new H(
          t.acceptAllLabel,
          t.saveSettingsLabel,
          G.fromJS(t.introduction),
          G.fromJS(t.categories.necessary),
          G.fromJS(t.categories.analytics),
          G.fromJS(t.categories.advertisement),
          G.fromJS(t.categories.functionality)
        );
      }
      getSanitizedText() {
        return new H(
          D(this.acceptLabel),
          D(this.saveSettingsLabel),
    ...
    class z {
      ...
      static fromJS(t) {
        return new z(
          ...
          t.declineLabel,
          t.disclaimer,
          t.modalText && t.modalText.cookieSettingsLabel,
          t.modalText && H.fromJS(t.modalText)
        );
      }
      getSanitizedText() {
        return new z(
          ...
          D(this.declineLabel),
          D(this.disclaimer),
          this.cookieSettingsLabel && D(this.cookieSettingsLabel),
    ...
    const W = 1,
      K = 2,
      j = 3,
      q = { [W]: "analytics", [K]: "advertisement", [j]: "functionality" };
    class V {
      constructor(t, e, n) {
        this.allowed = t;
      ...
      updateCategories({ analytics: t, advertisement: e, functionality: n }) {
        this.previousCategories = this.categories;
        this.categories = {
          necessary: !0,
          analytics: t,
      ...
      toCookieString() {
        return `${W}:${this.categories.analytics}_${K}:${this.categories.advertisement}_${j}:${this.categories.functionality}`;
      }
      static buildFromCookieString(t) {
        const e = t.includes(",") ? t.split(",") : t.split("_"),
          n = {
            necessary: !0,
            analytics: !1,
            advertisement: !1,
    ...
    class tt {
      ...
      addDomain(t) {
        ("." + this.context.getHostname()).endsWith(t) &&
    ...
    function mt(t, e, n) {
      var o,
        ...
        a = {};
      for (s in e)
        "key" == s ? (o = e[s]) : "ref" == s ? (i = e[s]) : (a[s] = e[s]);
      if (
        (arguments.length > 2 &&
          (a.children = arguments.length > 3 ? nt.call(arguments, 2) : n),
    ...
    function yt(t) {
      ((!t.__d && (t.__d = !0) && st.push(t) && !vt.__r++) ||
        rt !== ot.debounceRendering) &&
        ((rt = ot.debounceRendering) || at)(vt);
    }
    function vt() {
      for (var t; (vt.__r = st.length); )
        (t = st.sort(function (t, e) {
    ...
    function xt(t, e, n, o, i, s, a, r, c, l) {
      ...
      for (n.__k = [], h = 0; h < e.length; h++)
        if (
          ...
          (m = n.__k[h] =
            null == (m = e[h]) || "boolean" == typeof m
              ...
              : "string" == typeof m ||
                "number" == typeof m ||
                "bigint" == typeof m
              ? pt(null, m, null, null, m)
              : Array.isArray(m)
              ? pt(ft, { children: m }, null, null, null)
              : m.__b > 0
              ? pt(m.type, m.props, m.key, null, m.__v)
              : m)
        ) {
          if (
            ((m.__ = n),
            (m.__b = n.__b + 1),
            null === (u = _[h]) || (u && m.key == u.key && m.type === u.type))
          )
            _[h] = void 0;
          else
            for (d = 0; d < b; d++) {
          ...
          Ot(t, m, (u = u || ct), i, s, a, r, c, l),
            (p = m.__e),
            (d = m.ref) &&
              u.ref != d &&
              (g || (g = []),
              u.ref && g.push(u.ref, null, m),
              g.push(d, m.__c || p, m)),
            null != p
              ? (null == f && (f = p),
                "function" == typeof m.type && m.__k === u.__k
                  ? (m.__d = c = Ct(m, c, t))
                  : (c = kt(t, m, u, _, p, c)),
                "function" == typeof n.type && (n.__d = c))
              : c && u.__e == c && c.parentNode != t && (c = _t(u));
        }
      for (n.__e = f, h = b; h--; )
        null != _[h] &&
          ("function" == typeof n.type &&
            ...
            (n.__d = _t(o, h + 1)),
          Pt(_[h], _[h]));
      if (g) for (h = 0; h < g.length; h++) Nt(g[h], g[++h], g[++h]);
    }
    function Ct(t, e, n) {
    ...
    function kt(t, e, n, o, i, s) {
      ...
      if (void 0 !== e.__d) (a = e.__d), (e.__d = void 0);
        ...
        t: if (null == s || s.parentNode !== t) t.appendChild(i), (a = null);
          ...
          for (r = s, c = 0; (r = r.nextSibling) && c < o.length; c += 2)
            if (r == i) break t;
    ...
    function wt(t, e, n, o, i) {
      var s;
      for (s in n)
        "children" === s || "key" === s || s in e || Tt(t, s, null, n[s], o);
      for (s in e)
    ...
    function St(t, e, n) {
      "-" === e[0]
        ? t.setProperty(e, n)
        : (t[e] =
            null == n ? "" : "number" != typeof n || ht.test(e) ? n : n + "px");
    }
    function Tt(t, e, n, o, i) {
      ...
      t: if ("style" === e)
        if ("string" == typeof n) t.style.cssText = n;
          ...
          if (n) for (e in n) (o && n[e] === o[e]) || St(t.style, e, n[e]);
        }
      else if ("o" === e[0] && "n" === e[1])
        (s = e !== (e = e.replace(/Capture$/, ""))),
          ...
          (t.l[e + s] = n),
          n
            ? o || t.addEventListener(e, s ? Et : Lt, s)
            : t.removeEventListener(e, s ? Et : Lt, s);
    ...
    function Ot(t, e, n, o, i, s, a, r, c) {
      ...
      null != n.__h &&
        ((c = n.__h), (r = e.__e = n.__e), (e.__h = null), (s = [r])),
        (l = ot.__b) && l(e);
      try {
        t: if ("function" == typeof v) {
          if (
            ((g = e.props),
            (_ = (l = v.contextType) && o[l.__c]),
            (b = l ? (_ ? _.props.value : l.__) : o),
            n.__c
              ? (f = (h = e.__c = n.__c).__ = h.__E)
            ...
            null != v.getDerivedStateFromProps &&
              (h.__s == h.state && (h.__s = dt({}, h.__s)),
              dt(h.__s, v.getDerivedStateFromProps(g, h.__s))),
            (u = h.props),
            (m = h.state),
            d)
          )
            ...
            if (
              (null == v.getDerivedStateFromProps &&
                ...
                h.componentWillReceiveProps(g, b),
              (!h.__e &&
                null != h.shouldComponentUpdate &&
                !1 === h.shouldComponentUpdate(g, h.__s, b)) ||
                e.__v === n.__v)
            ) {
              (h.props = g),
                (h.state = h.__s),
            ...
            null != h.componentWillUpdate && h.componentWillUpdate(g, h.__s, b),
          ...
          (h.context = b),
            ...
            null != h.getChildContext &&
              (o = dt(dt({}, o), h.getChildContext())),
            d ||
              null == h.getSnapshotBeforeUpdate ||
              (p = h.getSnapshotBeforeUpdate(u, m)),
            (y =
              null != l && l.type === ft && null == l.key
                ? l.props.children
                : l),
            xt(t, Array.isArray(y) ? y : [y], e, n, o, i, s, a, r, c),
            (h.base = e.__e),
            (e.__h = null),
            h.__h.length && a.push(h),
            f && (h.__E = h.__ = null),
          ...
          null == s && e.__v === n.__v
            ...
            : (e.__e = It(n.__e, e, n, o, i, s, a, c));
        (l = ot.diffed) && l(e);
      } catch (t) {
        (e.__v = null),
          (c || null != s) &&
            ((e.__e = r), (e.__h = !!c), (s[s.indexOf(r)] = null)),
          ot.__e(t, e, n);
      }
    }
    function At(t, e) {
    ...
    function It(t, e, n, o, i, s, a, r) {
      ...
      if (null == t) {
        ...
        (t = i
          ...
          : document.createElement(m, u.is && u)),
          (s = null),
          (r = !1);
      }
      if (null === m) d === u || (r && t.data === u) || (t.data = u);
        ...
        if (
          ((s = s && nt.call(t.childNodes)),
          (l = (d = n.props || ct).dangerouslySetInnerHTML),
        ...
        r ||
          ("value" in u &&
            ...
            (p !== t.value ||
              ("progress" === m && !p) ||
              ("option" === m && p !== d.value)) &&
            Tt(t, "value", p, d.value, !1),
          "checked" in u &&
            void 0 !== (p = u.checked) &&
            p !== t.checked &&
            Tt(t, "checked", p, d.checked, !1));
      }
      return t;
    }
    function Nt(t, e, n) {
    ...
    function Pt(t, e, n) {
      var o, i;
      if (
        (ot.unmount && ot.unmount(t),
        (o = t.ref) && ((o.current && o.current !== t.__e) || Nt(o, null, e)),
        null != (o = t.__c))
      ) {
      ...
      if ((o = t.__k))
        for (i = 0; i < o.length; i++)
          o[i] && Pt(o[i], e, "function" != typeof t.type);
    ...
    function Dt(t, e, n) {
      var o, i, s;
      ot.__ && ot.__(t, e),
        (i = (o = "function" == typeof n) ? null : (n && n.__k) || e.__k),
        (s = []),
        Ot(
          e,
          (t = ((!o && n) || e).__k = mt(ft, null, [t])),
          i || ct,
          ct,
    ...
    (nt = lt.slice),
      ...
      (gt.prototype.setState = function (t, e) {
        ...
        (n =
          ...
          "function" == typeof t && (t = t(dt({}, n), this.props)),
          t && dt(n, t),
          null != t && this.__v && (e && this.__h.push(e), yt(this));
      }),
      (gt.prototype.forceUpdate = function (t) {
        this.__v && ((this.__e = !0), t && this.__h.push(t), yt(this));
      }),
      (gt.prototype.render = ft),
      (st = []),
      (at =
    ...
    (ot.__b = function (t) {
      ...
      (ot.diffed = function (t) {
        ...
        e &&
          e.__H &&
          e.__H.__h.length &&
          ((1 !== Ft.push(e) && Mt === ot.requestAnimationFrame) ||
            (
              (Mt = ot.requestAnimationFrame) ||
              function (t) {
                var e,
                  n = function () {
                    clearTimeout(o),
    ...
    ae.defaultProps = { color: "#15295A", size: "14px" };
    function re(t, e, n, o) {
      n &&
        o &&
    ...
    function he({ className: t, color: e, size: n }) {
      return Gt("svg", {
        version: "1.1",
        id: "plus-icon-svg",
        xmlns: "http://www.w3.org/2000/svg",
    ...
    he.defaultProps = { color: "#000022", size: "12px" };
    function de(t, e) {
      if (!e) return !1;
            ...
            children: [
              Gt("button", {
                ...
                children: [
                  ...
                  Gt("span", { dangerouslySetInnerHTML: R(n.label) }),
                ],
              }),
              !r &&
                Gt(le, {
    ...
    function ve({
      ...
      const [h, d] = $t(e.categories.analytics),
        [u, m] = $t(e.categories.advertisement),
        [p, b] = $t(e.categories.functionality),
        y = () => {
          i({ [_.ANALYTICS]: h, [_.ADVERTISEMENT]: u, [_.FUNCTIONALITY]: p });
        },
        v = () => {
          d(!0);
          m(!0);
    ...
    function xe({
      ...
      const [a, r] = $t(!1),
        ...
        h = ({ analytics: t, advertisement: n, functionality: o }) => {
          e.updateCategories({
            analytics: t,
            advertisement: n,
            functionality: o,
    ...
    function Ce({ apiBaseUrl: t, context: e, setting: n, onCloseBanner: o }) {
    ...
    function Se(t, e, n, o) {
      const i = ke(e);
      Dt(
        Gt(Ce, { apiBaseUrl: t, context: e, setting: n, onCloseBanner: o }),
        i
      );
      return i;
    }
    class Te {
      static postActivity(t, e, n) {
        fetch(t, {
          ...
          .then(() => L.info(`Sent a banner ${e} event.`))
          .catch(() =>
            L.error(`There was an issue sending a banner ${e} event.`)
          );
      }
      static sendView(t, e) {
    ...
    var Le = (t) => {
      I.setStyleOnBannerParent({ "--hs-banner-accentColor": t.accentColor });
    };
    class Ee {
      constructor(t) {
        this.privateMethods = [
      ...
      removeDeprecatedBannerCookies() {
        this.cookie.get(et.OPT_OUT_COOKIE.getName()) &&
          this.cookie.remove(et.OPT_OUT_COOKIE.getName());
        this.cookie.get(et.INITIAL_OPT_IN.getName()) &&
          this.cookie.remove(et.INITIAL_OPT_IN.getName());
      }
      run() {
        ...
        if (!this.matchedSetting) {
          ...
          this.setConsent(new V(!0), { reportClick: !1 });
          return !1;
        }
        ...
        if (this.shouldGpcOverride()) {
          this.setConsent(new V(!1), { persist: !1, reportClick: !1 });
          this.isGpcBannerDismissCookiePresent() || this.renderGpcBanner();
          return !0;
        }
        switch (this.matchedSetting.policy.type) {
          case M.NO_COOKIES:
            this.setConsent(new V(!1), { reportClick: !1 });
            break;
          case M.OPT_IN:
          case M.COOKIES_BY_CATEGORY: {
            const t = this.readConsentCookie();
            if (t) {
              this.setConsent(t, { persist: !1, reportClick: !1 });
          ...
          case M.NOTIFY:
            this.setConsent(new V(!0), { persist: !1, reportClick: !1 });
        ...
        for (const n of this.bannerSettings) {
          ...
          if (e) {
            if (o < i) e = n;
              ...
              e.configuration.getPriority() < n.configuration.getPriority() &&
                (e = n);
            }
          } else e = n;
        }
      ...
      setMatchingSetting(t) {
        ...
        this.privacySettingsListeners.forEach((t) =>
          this.safeCallListener(t, e)
        );
      }
      getMatchingSetting() {
      ...
      setApiBaseUrl(t) {
        /^https:\/\/js-?.{0,3}\.hs-banner(qa)?\.com.*/.test(t)
          ? (this.apiBaseUrl = t)
          : L.error("unsupported base Api url provided.");
      }
      setBannerSettings(t) {
        (t[this.context.getLocation().hostname] || []).forEach((t) =>
          this.bannerSettings.push(Y.fromJS(t))
        );
      }
      ...
      setConsentCookie() {
        ...
        t !== M.NO_COOKIES &&
          t !== M.COOKIES_WITHOUT_BANNER &&
          this.cookie.set(
            et.CATEGORY_PREFERENCE_COOKIE.getName(),
      ...
      revokeCookieConsent() {
        [
          et.INITIAL_OPT_IN.getName(),
          et.OPT_OUT_COOKIE.getName(),
          et.CATEGORY_PREFERENCE_COOKIE.getName(),
          et.GPC_BANNER_DISMISS_COOKIE.getName(),
          "__hssc",
          "__hssrc",
          "__hstc",
          "__hs_do_not_track",
          "hubspotutk",
          "messagesUtk",
        ].forEach((t) => this.cookie.remove(t));
        this.trackAction("trackRevokeCookieConsent");
        this.setConsent(new V(!1), { reportClick: !1 });
      }
      addPrivacySettingsListener(t) {
        this.matchedSetting &&
          this.safeCallListener(t, this.matchedSetting.toLegacyPrivacyPolicy());
      ...
      run() {
        ...
        if (!t[l]) {
          ...
          this.banner.useGeoLocation
            ? this.banner.getCurrentGeoLocation().then((t) => {
    ...
    "loading" === Ne.readyState
      ? Ne.addEventListener("DOMContentLoaded", Pe)
      : Ie();
  },
]);
/****** Cookie Banner version static-1.1323 *****/
