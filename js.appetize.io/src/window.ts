    ...
    implements AppetizeWindowProtocol
{
    ...
    constructor({
        ...
        // embed forwards all socket events including errors to us. EventEmitter
        // will automatically throw `error` events if there are no event listeners.
        // since socket error events aren't terribly helpful, we'll register a noop to prevent
