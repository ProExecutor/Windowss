!(function (e) {
  ...
  t.p = "//static.hsappstatic.net/adsscriptloaderstatic/static-1.496/";
  t((t.s = 0));
})([
  function (e, n, t) {
    "use strict";
    ...
    function c() {
      ...
      e = parseInt(e, 10);
      if (!e)
        throw new Error("HS Pixel Loader can't identify portalId via " + o);
      return e;
    }
    function l() {
      return d(a) || "na1";
    ...
    const y = function (e) {
      ...
      j = function () {
                  ...
                  : _(
                      {
                        jsonUrl:
                          t +
                          "/hs-script-loader-public/v1/config/pixels-and-events/json",
                        jsonpUrl:
                          t +
                          "/hs-script-loader-public/v1/config/pixels-and-events/jsonp",
                      },
                      (e) => {
                        i = e.pixels;
                        b(e.pixels, a);
        ...
        function d(e, n) {
          const { hubSpotFormId: t, pixelId: i, conversionLabel: a } = e,
            { conversionId: r, formGuid: d } = n;
          o = function () {
...
//# sourceMappingURL=//static.hsappstatic.net/adsscriptloaderstatic/static-1.496/bundles/pixels-release.js.map
